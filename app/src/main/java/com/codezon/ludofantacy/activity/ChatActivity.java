...
import com.codezon.ludofantacy.adapter.MessageAdapter;
...
import com.codezon.ludofantacy.model.Notification;
        ...
        try {
            mRootRef.child("Users").child(mChatUser).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                    ...
                    Picasso.get().load(AppConstant.API_URL+image).placeholder(R.drawable.default_avatar).into(mProfileImage);
                }

                @Override
                public void onCancelled(@NotNull DatabaseError databaseError) {
                    mTitleView.setText(userName);
                    Picasso.get().load(AppConstant.API_URL+Preferences.getInstance(ChatActivity.this).getString(Preferences.KEY_PROFILE_PHOTO)).into(mProfileImage);
                }
            });
        }catch (NullPointerException e) {
            mTitleView.setText("User");
            Picasso.get().load(AppConstant.API_URL+"default_avatar.png").placeholder(R.drawable.default_avatar).into(mProfileImage);
        }
