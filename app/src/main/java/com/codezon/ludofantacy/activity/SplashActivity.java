...
import com.codezon.ludofantacy.BuildConfig;
...
import com.codezon.ludofantacy.model.AppModel;
                ...
                if (response.isSuccessful()) {
                    ...
                    if (legalData != null) {
                        ...
                        if (res.get(0).getSuccess() == 1) {
                            int maintenanceMode = res.get(0).getMaintenance_mode();

                            AppConstant.COUNTRY_CODE = res.get(0).getCurrency_code();
                            AppConstant.CURRENCY_CODE = res.get(0).getCurrency_code();
                            AppConstant.CURRENCY_SIGN = res.get(0).getCurrency_sign();
                            AppConstant.REFER_PERCENTAGE = res.get(0).getRefer_percentage();
                            AppConstant.MAINTENANCE_MODE = res.get(0).getMaintenance_mode();
                            AppConstant.M_ID = res.get(0).getPaytm_mer_id();
                            AppConstant.MERCHANT_ID = res.get(0).getPayu_id();
                            AppConstant.MERCHANT_KEY = res.get(0).getPayu_key();
