...
import com.codezon.ludofantacy.fragment.DialogFullscreenFragment;
import com.codezon.ludofantacy.helper.AppConstant;
import com.codezon.ludofantacy.helper.Preferences;
import com.codezon.ludofantacy.model.Messages;
import com.codezon.ludofantacy.R;
import com.codezon.ludofantacy.utils.GetTimeAgo;
    ...
    public void onBindViewHolder(@NotNull final MessageViewHolder viewHolder, int i) {
        ...
        if (Preferences.getInstance(context).getString(Preferences.KEY_USER_ID).equals(from_user)) {
            ...
            try {
                mUserDatabase.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                        ...
                        Picasso.get().load(AppConstant.API_URL+image).placeholder(R.drawable.default_avatar).into(viewHolder.profileRightImage);
                    }
                ...
                Picasso.get().load(AppConstant.API_URL+"default_avatar.png").placeholder(R.drawable.default_avatar).into(viewHolder.profileRightImage);
            }
            ...
            if(message_type.equals("text")) {
                ...
                Picasso.get().load(c.getMessage()).placeholder(R.drawable.placeholder_post).into(viewHolder.messageRightImage);
            }
        }
        else {
            viewHolder.messageRightText.setVisibility(View.GONE);
            ...
            mUserDatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                    ...
                    Picasso.get().load(AppConstant.API_URL+image).placeholder(R.drawable.default_avatar).into(viewHolder.profileImage);
                }
            ...
            if(message_type.equals("text")) {
                ...
                viewHolder.messageText.setVisibility(View.GONE);
                Picasso.get().load(c.getMessage()).placeholder(R.drawable.placeholder_post).into(viewHolder.messageImage);
            }
        }
