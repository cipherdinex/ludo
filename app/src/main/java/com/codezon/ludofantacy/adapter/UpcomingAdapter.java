...
import com.codezon.ludofantacy.view.VerticalTextView;
        ...
        try {
            ...
            try {
                if (Integer.parseInt(currentTime) >= Integer.parseInt(startTime)) {
                    ...
                    setTime(time * 1000, holder.timerTv, holder.joinBt, holder.roomSizeTv, holder.roomStatusTv, holder.progressBar, position);
                    startCountDown();
                }
            }
