...
import com.codezon.ludofantacy.model.AppUpdateModel;
...
public interface ApiCalling {
    ...
    Call<UserModel> postDeposit(
            @Field("purchase_key") String access_key,
    ...
    @GET(ApiConstant.GET_HOW_TO_PLAY)
    Call<ConfigurationModel> getHowTpPlay(
            @Query("purchase_key") String purchase_key);
    ...
    @GET(ApiConstant.GET_UPDATE)
    Call<AppUpdateModel> getUpdateApp(
            @Query("purchase_key") String purchase_key);
}
